...
{
    /**
     * Return a valid citation for this resource via a conversion into csl.
     *
    ...
    protected function convertToCsl(AbstractResourceEntityRepresentation $resource)
    {
        $csl = [];

        // Some mappings are useless for a standard bibliographic reference, but
        // csl are very numerous, so try to map as many fields as possible.
